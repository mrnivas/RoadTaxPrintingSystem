//Modal Controller
FHMOD.controller("ManageRolesModels",function($scope,$uibModalInstance,items){
...
//Controller
FHMOD.controller("ManageRoles",function($scope,$uibModal){
